...
sudo systemctl restart maekjeom-bot maekjeom-bot-15m

## 봇 상태 확인 (서버에서)
systemctl status maekjeom-bot maekjeom-bot-15m --no-pager
ps aux | grep ws_watch          # 정상이면 python3 -u ws_watch.py / ws_watch_1m.py 딱 2개
