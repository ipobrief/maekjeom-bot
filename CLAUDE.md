...
- **🏹 눌림목·반등목 전용방(2026-08-23, 맥점 그룹 -1003964313330 내 토픽): BTC=1619 / XAU=1620** (`TELEGRAM_THREAD_ID_PULLBACK`, XAU override=1620). 3·5·10분 신호 중 `pullback_note` 조건이면 맥점방/막돌파방 대신 여기로만 발송(`emit_pullback`). 10·30분용 별도방 없이 합침(30분은 신호중단이라 제외).
