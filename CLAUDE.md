...
- **⭐ 방 통합(2026-09-11)**: 막돌파·맥점·눌림목 전부 **맥점 토픽 하나로**(BTC 3분=558/5분=574/10분=911). `emit_breakout`·`emit_pullback`→`tg_send`. **XAU 전면 중단**(xau-3m/5m/10m stop+disable). 헬스체크 BTC 3봇. 막돌파방 그룹·눌림목·XAU 토픽 미사용(잔존).
