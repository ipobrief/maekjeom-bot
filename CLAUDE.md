...
- **🏹 눌림목·반등목 전용방(2026-08-23, 맥점 그룹 -1003964313330 내 토픽): BTC=1619 / XAU=1620** (`TELEGRAM_THREAD_ID_PULLBACK`, XAU override=1620). 3·5분 신호 중 `pullback_note` 조건이면 맥점방/막돌파방 대신 여기로만 발송(`emit_pullback`).
